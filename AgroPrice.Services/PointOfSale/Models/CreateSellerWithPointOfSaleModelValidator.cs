...
{
    public class CreateSellerWithPointOfSaleModelValidator : AbstractValidator<CreateSellerWithPointOfSaleModel>
    {
        private readonly UserManager<IdentityUser> _userManager;

        public CreateSellerWithPointOfSaleModelValidator(UserManager<IdentityUser> userManager)
        {
